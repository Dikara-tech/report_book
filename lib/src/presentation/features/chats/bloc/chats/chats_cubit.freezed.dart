...
abstract class $ChatsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ChatModel> chats, bool isError});
}
...
class _$ChatsStateImpl implements _ChatsState {
  const _$ChatsStateImpl(
      {required final List<ChatModel> chats, required this.isError})
      : _chats = chats;
  ...
  @override
  String toString() {
    return 'ChatsState(chats: $chats, isError: $isError)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_chats), isError);
...
abstract class _ChatsState implements ChatsState {
  const factory _ChatsState(
      ...
      required final bool isError}) = _$ChatsStateImpl;
